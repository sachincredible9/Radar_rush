                  ...
                  Center(
                    child: ElevatedButton(
                      ...
                      style: ElevatedButton.styleFrom(
                        ...
                        padding: EdgeInsets.symmetric(horizontal: isIPad ? 80 : 50, vertical: isIPad ? 20 : 14),
                        shape: RoundedRectangleBorder(borderRadius: BorderRadius.circular(12)),
                      ),
                      child: Text('DISMISS MANUAL', style: GoogleFonts.orbitron(color: Colors.white, fontSize: isIPad ? 22 : 16, fontWeight: FontWeight.bold)),
                    ),
                  ),
                ],
              ),
